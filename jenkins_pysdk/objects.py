...
#     objects: List[JenkinsDataObject or JenkinsViewObjects or JenkinsJobObjects]  # TODO: Fix hardcode
#
#     def list(self) -> JenkinsDataObject or JenkinsViewObject or JenkinsJobObject:
#         for obj in self.objects:
...
#             yield obj._as_dict()
#
#     def append(self, obj: JenkinsDataObject or JenkinsViewObjects or JenkinsJobObjects): # TODO: Fix hardcode
#         self.objects.append(obj)
